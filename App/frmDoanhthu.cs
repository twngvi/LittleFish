...
namespace App
{
    ...
    {
        private bool isExiting = false; // Biến xác định người dùng muốn thoát
        public frmDoanhthu()
        {
            InitializeComponent();
            this.FormClosing += frmDoanhthu_FormClosing; // Gắn sự kiện đóng form
        }
