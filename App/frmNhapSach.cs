...
namespace App
{
    ...
    public partial class frmNhapSach : Form
    {
        ...
        private bool isExiting = false; // ✅ tránh spam xác nhận
        public frmNhapSach()
        {
            InitializeComponent();
            this.FormClosing += frmNhapSach_FormClosing; // ✅ gắn sự kiện xác nhận
        }
        ...
        private void frmNhapSach_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                DialogResult result = MessageBox.Show("Bạn có muốn thoát chương trình?", "Xác nhận",
